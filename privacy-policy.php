                ...
                <div class="col-12">
                    ...
                    <ul>
                        <li><strong>Personal Information:</strong> Information that can be used to identify you, such as
                            your name, email address, phone number, and billing information.</li>
                        <li><strong>Usage Data:</strong> Data regarding your interactions with our website, including
                            pages visited, time spent on pages, clicks, and browsing patterns.</li>
                        <li><strong>Cookies and Tracking Technologies:</strong> We use cookies, web beacons, and similar
                            technologies to improve your experience, customize content, and understand how our website
                    ...
                    <ul>
                        ...
                        <li><strong>To Communicate with You:</strong> To respond to inquiries, provide support, send
                            updates, and communicate marketing or promotional messages.</li>
                        <li><strong>To Personalize User Experience:</strong> To deliver customized content and improve
                            website navigation.</li>
                        <li><strong>To Comply with Legal Obligations:</strong> To meet regulatory requirements, legal
