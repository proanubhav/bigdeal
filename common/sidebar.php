          <div class="service_sidebar">
            <div class="bg-company_registration service_img_sprit"></div>
            <a href="tel:+91 9468065626"><button class="btn btn-primary">Call Now</button></a>
            <a href="mailto:info@startupclubindia.com"><button class="btn btn-secondary">Email Me</button></a>
            <div class="sidebar_card">
              <p><small>100% Response Ratio</small></p>
            ...
            <form method="POST" action="./ajax/contact.php" id="sidebar-form">
              <div class="row">
                ...
                <a href="tel:+91 9468065626" class="tel_link">Call: 9468065626</a>
              </div>
            </form>
          </div>