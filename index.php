...
<body>
        ...
        <div class="col-md-6">
          <div class="banner-home__content pb-lg-60 pb-md-50 pb-sm-45 pb-xs-40">
            ...
            <div class="description font-la color-white mb-45 mb-sm-15 mb-md-30 mb-sm-25 mb-xs-20">
              <p>Join the Bigdeal Supermarket Franchise in India and start a mini grocery store or mart with low supermarket franchise costs.
              </p>
            </div>
        ...
        <div class="row">
          <div class="col-6 col-md-3">
            <div class="feat_card">
              ...
              <h3>Low-Cost, High-Reward</h3>
              <p>Big Deal Supermarket franchise presents a great opportunity for low-entry investment and high-return prospects. Given the low operating costs and effective management, you can realize high profits without incurring high risks, hence making it a worthwhile investment.</p>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="feat_card">
              ...
              <p>Utilize our 10 years of experience in business that guarantees results. Every single aspect of our strategy, from stock control to ways of interacting with the audience, is aimed at achieving progressive development and eternal viability in the competitive market.</p>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="feat_card">
              <img src="assets/img/code_review.svg" alt="Experienced Team">
              <h3>Trustworthy Collaboration</h3>
              <p>Joining forces with Big Deal grocery store franchise assures association with a reliable brand, which is based on the principles of honesty and transparency. Our people will closely engage with your team and promote a flourishing business partnership that lasts.</p>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="feat_card">
              <img src="assets/img/breakfast.svg" alt="Trusted Partner">
              <h3>Rapid Market Expansion</h3>
              <p>Take advantage of the increasing need for quality grocery services in India. With Big Deal you can efficiently grow your presence in the region, reach new audiences, develop strong customer bases, and defend your interests in the retail market.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="col-12 col-md-5 col-lg-6">
    <div class="service_content sticky-left">
      ...
      <div class="btn-box">
        <button class="btn btn-border" data-target="#enquiryModal" data-toggle="modal">
      ...
      <div class="col-6 col-md-6 col-lg-6">
        <div class="services_card card_margin">
          ...
          <div class="serv_card_cont">
            <h2><a href="trademark-registration" title="Trademark Registration">Brand Recognition</a></h2>
            <p>You can use the fame of the Big Deal Supermart to help win the initial customers who are loyal to the brand.</p>
          </div>
        </div>
        <div class="services_card">
          <div class="bg-trademark_registration service_img_sprit"></div>
          <div class="serv_card_cont">
            <h2><a href="online-accounting-and-book-keeping-services" title="Online Accouting Services">Diverse Product Range</a></h2>
            <p>We provide variety in product range to every customer’s need to encourage their return.</p>
          </div>
        </div>
        <div class="services_card">
          <div class="bg-ngo_registration service_img_sprit"></div>
          <div class="serv_card_cont">
            <h2><a href="appointment-of-directors-in-a-company" title="Appointment of Director">Engaging Community Events</a></h2>
            <p>We conduct entertaining local activities as they help increase presence as well as customer loyalty in the region.</p>
          </div>
        </div>
      </div>
      <div class="col-6 col-md-6 col-lg-6">
        <div class="services_card">
          ...
          <div class="serv_card_cont">
            <h2><a href="appointment-of-directors-in-a-company" title="Appointment of Director">Speedy 45-day Openings</a></h2>
            <p>Opening a franchise can be done in less than 2 months which means the franchisee can start earning within the least time possible.</p>
          </div>
        </div>
        <div class="services_card">
          <div class="bg-one_person_company service_img_sprit"></div>
          <div class="serv_card_cont">
            <h2><a href="appointment-of-directors-in-a-company" title="Appointment of Director">Ongoing Training</a></h2>
            <p>Enjoy regular training programs for you and your staff allowing you to keep updated with what is happening in the industry.</p>                    
          </div>
        </div>
        <div class="services_card">
          <div class="bg-one_person_company service_img_sprit"></div>
          <div class="serv_card_cont">
            <h2><a href="appointment-of-directors-in-a-company" title="Appointment of Director">Customizable Business Model</a></h2>
            <p>Enjoy a customizable business model that allows you to personalize your store while following proven guidelines.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="why_startups">
          <div class="row">
            <div class="col-lg-12">
              ...
              <p>We know that the world is full of surprises and there comes a time when you will need even the most basic of things. That is the most important reason why you should always have a good store around you. Picture having a place where you can buy everything from cooking essentials to grocery items, which are required daily. What’s more, we even have hot meals for you to take home.</p>
              <p>In the Big Deal Supermart franchise, you enjoy all these services with great efficiency, meaning you have what you want when you want it. Because we focus on quality and customer satisfaction we have become the most preferred grocery outlet for the daily needs of our esteemed customers.</p>
              <p>Get in touch with us today so that we can help you learn about our supermarket franchise business opportunities and help you take that first exciting step towards your entrepreneurial dream!</p>
              <h3>The Simple Steps to Franchise Ownership</h3>
              <p>If you're considering making the right decision and buying a franchise, there are several things to pay attention to before signing the franchise agreement:</p>
              <p>For starters, it is necessary to find the time to propose, schedule an appointment and brief it appropriately. This is an important step for the future relations with the franchisor.</p>
              <p>In the next step, carry on a site survey to check if the location you have chosen for the franchise is acceptable. The location is a crucial factor to the business and therefore it is important for the location chosen to be appropriate.</p>
              <p>After you have found a sight, there is a site approval process with the franchise. This is an important stage of operation of the franchise when it is necessary to confirm that all requirements and standards of ability to run the franchise are fulfilled.</p>
              <p>After the verification is completed, you may move on by activating your area code and collecting your welcome kit which consists of essential tools to kick-start your operations.</p>
              <p>To conclude, do not forget to attend the grand opening of your franchise as well.</p> 
              <p>With these steps, you are quite ready to enjoy the pleasures of being a franchise owner!</p>

              <h3>Holistic Profit with Big Deal Supermart</h3>
              <p>In the Indian retail industry, ‘Big Deal Supermart’ has become one of the most recognizable names with its mission being to provide the best products at competitive prices. 2015 marked the beginning of a new franchise model that has grown exponentially within a short period owing to the dedication to quality and social responsibility. We boast of opening stores all over India in just a couple of years, with industry standards in supermarket opening histories.</p>
              <p>We have a wide range of products, such as fresh fruits and vegetables, groceries, home and personal care items, nutritional products, etc. We offer the best products possible while trying our best to keep the prices low so that our franchisees can get good profits and improve the return on their investments.</p>
              <p>The advantages of operating on the market as a franchisee of Big Deal Supermart include the existing brand name and the marketing support which allows you to operate efficiently. The profitability of the Big Deal Supermart franchise is high for an active person and is about 20%, which makes around ₹2,00,000 per month. Well-established logistic schemes and constant education in business processes put you in a position to make a prosperous business run.</p>

              <p>Contact us now if you would like to explore more about evolving as a franchise for Big Deal Supermart and start working towards your financial freedom rapidly!
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container container-1">
        <div class="row row-30 row-lg align-items-center">
          ...
          <div class="col-lg-5 col-xl-4 offset-lg-1">
            ...
            <p class="big wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">At <span
                class="main-green">Big Deal Supermart</span>, we celebrate community, love, and aspirations. Since years back, when the fond memories of local markets as a child fueled the dream, the kitchens were filled with the noise of families coming together and neighbours becoming friends.</p>
            <p class="big wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Whenever stepping in, one ceases to be a shopper and instead becomes a family member. Every fresh produce item, every essential grocery, and every household good is a reflection of our commitment to quality and affordability for every family. With every choice in our favour, you give chances to the farmers and artisans so that they can grow along with us.</p>
            <p class="big wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Together, we will build a space where every person wins, and start a mini supermarket filled with emotion. Allow us to extend our heart, strength and success to this cause.</p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div id="accordion">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                The cost of investment in a franchise under BigDeal generally lies between ₹10 to ₹25 lakhs, based on the location and size of the outlet. This encompasses the franchise fees, equipment, stock, and also the running costs. Our team gives a detailed analysis for you to understand the breakdown of all the costs involved.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                For four weeks, we offer in-depth training focused on how to operate a store, manage the stock, interact with customers, and implement marketing tactics. Our continuing support helps you keep up with the current market trends and practices so that you prepare well for the running of your franchise, thus paving the way for the future success of the business.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
                There is no mandatory requirement for anyone to have worked in a retail environment before starting a franchise, although it is advantageous if they have. You will learn everything you need to efficiently operate a store in our comprehensive training program. Enthusiasm for service and readiness to be taught are important.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                <div class="card-body">
                Once the franchise has been opened, there is continuous support that is offered to the franchisee concerning the operations of the business, marketing and event management. Also included are updates concerning the business environment and trends quarterly, along with quarterly business reviews to provide you with all necessary tools to further enhance your profitability and achieve your business objectives.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                <div class="card-body">
                BigDeal aims to satisfy all customers by providing quality products. We have worked with more than a hundred suppliers who we trust and we regularly inspect their quality. We pay particular attention to young perishable goods and equity goods aiming at letting its franchisees offer the most affordable quality products to consumers.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
                <div class="card-body">
                Most BigDeal franchises earn approximately 20% profit margins. The above-stated margins vary with the site, the size of the store, and how well the business is managed. Additionally, the structure of our business operations and constant help from our consultants serve to help enhance your returns and make profits when it comes to the retail markets.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
                <div class="card-body">
                Complete the application form on the BigDeal franchise website. After receiving and reviewing your application, we will arrange a meeting in order to get to know you and your objectives, perform a visit to the location and provide you with information on the further course of action.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion">
                <div class="card-body">
                A Franchisee can expect an ROI of about 30% within the next 18-24 months of starting activities. This may change to regions, management efficiency, and community integrities but as we have proven strategies and support, you will earn much more than expectations.
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion">
                <div class="card-body">
                BigDeal provides strong marketing assistance such as creating and implementing online marketing plans, running branding advertisements, and providing collateral. Franchisees are provided with marketing kits every 3 months consisting of marketing materials appropriate to the target market making sure the store has customers and retains them while creating brand equity.
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion">
                <div class="card-body">
                Although running a grocery franchise on a part-time basis is achievable, we do advocate full-time to run the franchise for maximum efficacy. Daily participation in the operations helps foster good customer relations and facilitates the running of the store, therefore increasing profitability and customer satisfaction.
                </div>
              </div>
            </div>
            ...
            <div class="wpb_wrapper-inner">
              <div class="wpb_text_column wpb_content_element ">
                <div class="wpb_wrapper text-center">
                  ...
                  <h2 class="text-center">Build your Beautiful and Secure Future with us Right Now!</h2>
                  <p class="text-center text-white">Opt for a BigDeal Supermarket Franchise today and ensure your future self with financial security and the opportunity to build a thriving business. Cater to your community and seek everyone’s blessings!</p>
                  <div class="btn-box">
